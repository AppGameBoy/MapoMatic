...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.1 on Sun May  2 18:28:17 2021
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        sizer_2.Add(self.checkbox_1, 0, wx.ALL, 11)
        ...
        self.Bind(wx.EVT_SEARCHCTRL_SEARCH_BTN, self.on_enter, self.text_ctrl__copy)
        self.Bind(wx.EVT_TEXT, self.on_enter, self.text_ctrl__copy)
        self.Bind(wx.EVT_TEXT_ENTER, self.on_enter, self.text_ctrl__copy)
        # end wxGlade
